...
/**
 * Bean lié à la page createPerson.xhtml, qui permet de créer une nouvelle personne ou de la modifier
 * @author DeillonM
 */
...
public class PersonCreateBean implements Serializable{
     ...
     * @return "success" si l'enregistrement se passe bien, "errorDuplicate" si le numéro de la personne est déjà utilisé.
     */
